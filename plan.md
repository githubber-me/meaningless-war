...
### Phase C — Hero regeneration (target spend: under $9, cumulative)
...
**Gate C:** cumulative spend under $9.00. All finals in `generation/finals/`, grayscale-verified programmatically (assert max channel divergence near zero).
